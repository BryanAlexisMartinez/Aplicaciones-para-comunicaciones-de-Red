...
ArrayList <String> Serverdisp=new ArrayList <String>();
ArrayList <String> disponibles=new ArrayList <String>();
ArrayList <String> ServerPortRMI=new ArrayList <String>();
Thread hilo;
...
//DatagramSocket socket = canal.socket();
            ...
            //CEcoUDPNB cliente =new CEcoUDPNB ();
            while(true){
                if (wait.Segundos>0){
    ...
    //                        int eco = buffer.getInt();
                           //0.direccion-1.puerto-2.disponible-3puertoRMI
                            ...
                            if(Datos.length>1){
                                ...
                                if (NoEsta){
                                    ...
                                    //ServerIP.add(Datos[0]);
                                    //System.out.println(Datos[0]+" efe "+Datos[1]);
